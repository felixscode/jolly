...
<div class="mx-auto max-w-4xl px-4 pt-8 pb-12 md:px-6 md:pt-16 md:pb-24">
	...
	<div class="mb-8 grid grid-cols-3 gap-2 text-xs text-gray-400 md:mb-16 dark:text-gray-500">
		<span><strong>Exact Match</strong> — identical to expected</span>
		<span><strong>Errors Fixed</strong> — typos caught (%)</span>
		<span><strong>Score</strong> — similarity (0–1)</span>
		<span><strong>Time</strong> — wall-clock ms</span>
		<span><strong>Memory</strong> — RSS in MB</span>
	</div>
